...
module design_top_wrapper (
    ...
    wire       S_pll_lock;
    wire       S_rst;
	wire       S_pixel_clk;     //synthesis keep = true; 
    wire       S_serial_clk;
    ...
    wire       S_key_trig;   //synthesis keep = true; 
    wire       S_edid_valid; //synthesis keep = true; 
    wire[7:0]  S_edid_data;  //synthesis keep = true; 
    ...
    hdmi_phy_wrapper  #(
        .DEVICE ( "PH1A" )  //"EF2","EF3","EF4","SF1","EG","PH1A","PH1P","DR1"
    )u_hdmi2phy_wrapper(
        .I_pixel_clk        ( S_pixel_clk     ),
