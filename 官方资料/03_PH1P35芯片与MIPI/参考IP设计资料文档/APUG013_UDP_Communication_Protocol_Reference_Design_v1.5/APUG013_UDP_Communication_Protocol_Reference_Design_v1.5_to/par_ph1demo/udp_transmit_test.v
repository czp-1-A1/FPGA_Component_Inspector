...
//              添加 soft fifo 
//              添加 debug 功能
// 2023/02/09 :add dynamic_local_ip_address port
// 2024/02/21 :add ADDR_WIDTH for MAC rx_client_fifo/tx_client_fifo/
// 2024/07/23 :correct checksum error
//
// web：www.anlogic.com 
//------------------------------------------------------------------- 
//*********************************************************************/
...
assign  mac_cfg_vector    = {1'b0,2'b00,TRI_speed,8'b00100010,7'b0100010}; //地址过滤模式、流控配置、速度配置、接收器配置、发送器配置
...
(   
    ...
    .input_local_udp_port_num      ('d0      ),
    .input_local_udp_port_num_valid('d0),
    
    .input_local_ip_address     ('d0     ),
    .input_local_ip_address_valid('d0),
...
(
    ...
    .wr_sreset            (reset                    ),//input 
    .wr_data              (temac_tx_data            ),//input 
    .wr_sof_n             (temac_tx_sof             ),//input 
    .wr_eof_n             (temac_tx_eof             ),//input 
    .wr_src_rdy_n         (temac_tx_valid           ),//input 
    .wr_dst_rdy_n         (temac_tx_ready           ),//output
    .wr_fifo_status       (                         ) //output
);
